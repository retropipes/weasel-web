...
import com.puttysoftware.weaselweb.maze.objects.NormalAmulet;
import com.puttysoftware.weaselweb.maze.objects.RegularBoots;
...
public final class ObjectInventory implements Cloneable {
	...
	final MazeObjectList list = WeaselWeb.getApplication().getObjects();
	final MazeObject[] objects = list.getAllInventoryableObjectsMinusSpecial();
	...
	i.amulet = (GenericAmulet) objects.readMazeObject(reader, formatVersion);
	if (i.amulet == null) {

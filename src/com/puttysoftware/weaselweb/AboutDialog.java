...
public class AboutDialog implements AboutHandler {
	...
	this.aboutFrame = new JFrame("About WeaselWeb");
	...
	this.textPane.add(new JLabel("WeaselWeb Version: " + ver));
	this.textPane.add(new JLabel("Author: Eric Ahnell"));
	this.textPane.add(new JLabel("Web Site: http://www.puttysoftware.com/weaselweb/"));

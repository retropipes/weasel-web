...
public abstract class GenericProgrammableLock extends GenericSingleLock {
	...
	if (this.isConditionallyDirectionallySolid(ie, dirX, dirY, inv)) {
		...
		WeaselWeb.getApplication().showMessage("You need a " + this.getKey().getName());
	    }
	}
	...
	final MazeObject o = WeaselWeb.getApplication().getObjects().readMazeObject(reader, formatVersion);
	if (o == null) {

...
public abstract class GenericButton extends MazeObject {
	...
	WeaselWeb.getApplication().getMazeManager().getMaze().findAllObjectPairsAndSwap(this.offState, this.onState);
	WeaselWeb.getApplication().getGameManager().redrawMazeNoRebuild();

...
public class ShockBomb extends GenericUsableObject {
	...
	WeaselWeb.getApplication().getMazeManager().getMaze().radialScanShockObjects(x, y, z, ShockBomb.EFFECT_RADIUS);
	// Shock the ground, too
	WeaselWeb.getApplication().getMazeManager().getMaze().radialScanShockGround(x, y, z, ShockBomb.EFFECT_RADIUS);
    }

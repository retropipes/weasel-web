...
public class IceBomb extends GenericUsableObject {
	...
	WeaselWeb.getApplication().getMazeManager().getMaze().radialScanFreezeObjects(x, y, z, IceBomb.EFFECT_RADIUS);
	// Freeze ground, too
	WeaselWeb.getApplication().getMazeManager().getMaze().radialScanFreezeGround(x, y, z, IceBomb.EFFECT_RADIUS);
    }

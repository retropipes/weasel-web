...
public class FireBomb extends GenericUsableObject {
	...
	WeaselWeb.getApplication().getMazeManager().getMaze().radialScanEnrageObjects(x, y, z, FireBomb.EFFECT_RADIUS);
	// Burn the ground, too
	WeaselWeb.getApplication().getMazeManager().getMaze().radialScanBurnGround(x, y, z, FireBomb.EFFECT_RADIUS);
    }

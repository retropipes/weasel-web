...
public class HalfHourglass extends GenericTimeModifier {
	...
	WeaselWeb.getApplication().getMazeManager().getMaze().extendTimerByInitialValueHalved();
	SoundManager.playSound(SoundConstants.SOUND_CATEGORY_SOLVING_MAZE, SoundConstants.SOUND_GRAB);
	WeaselWeb.getApplication().getGameManager().addToScore(HalfHourglass.SCORE_GRAB);
    }
